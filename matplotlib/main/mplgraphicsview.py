...
class MplGraphicsView(QtGui.QWidget):
    ...
    def set_axis_label(self, axis_x, label, axis_number=0, font_size=20):
        """
        ...
        """
        self._myCanvas.set_axis_label(axis_x, label, axis_number, font_size)
...
class Qt4MplCanvas(FigureCanvas):
    ...
    def set_axis_label(self, axis_x, label, axis_number=0, font_size=20):
        ...
        if axis_x:
            if axis_number == 0:
                self.axes.set_xlabel(label, fontsize=font_size)
            else:
                self.axes2.set_xlabel(label, font_size)
        else:
            if axis_number == 0:
                self.axes.set_ylabel(label, font_size)
            else:
                self.axes2.set_ylabel(label, font_size)
        # END-IF
    ...
    def _setupLegend(self, location='best'):
        ...
        self._legend = self.axes.legend(handles, labels, loc=location)
        # print handles
        # print labels
